...
local config = {
    ...
    snapshot_height = 720,      -- same
    audio_format = "opus",      -- opus or mp3
    audio_bitrate = "32k",      -- from 16k to 32k
    deck_name = "Sentence Bank",     -- the deck will be created if needed
    model_name = "MIA Jpn DX", -- Tools -> Manage note types
    sentence_field = "Sentence",
    audio_field = "Sentence Audio",
    use_forvo = "yes",                  -- 'yes', 'no', 'always'
    vocab_field = "Word",         -- target word field
    vocab_audio_field = "Word Audio",   -- target word audio
    image_field = "Image",
    menu_font_size = 25,
    note_tag = "",      -- the tag that is added to new notes. change to "" to disable tagging
